    ...
    <form method="POST" id="general" action="/settings">
      <table align="center">
        ...
        <tr>
          <td>Name:</td>
          <td>
            <input type="text" id="selfName" size="20" name="selfName">
          </td>
        </tr>
        <tr>
          <td>SSID:</td>
        ...
        <tr>
          <td>Self AP:</td>
          <td>
            <input type="checkbox" id="selfAP" value="1" name="selfAP">Enable
          </td>
        </tr>
        <tr>
          <td>WPA2 Key:</td>
          <td>
            <input type="text" id="selfWPA2" size="20" name="selfWPA2">
          </td>
        </tr>
        <tr>
          <td>Login:</td>
          <td>
            <input type="text" id="selfLOGIN" size="20" name="selfLOGIN">
          </td>
        </tr>
        <tr>
          <td>Pasword:</td>
          <td>
            <input type="password" id="selfPASS" size="20" name="selfPASS">
          </td>
        </tr>
        <tr>
          <td>Repeat Pasword:</td>
          <td>
            <input type="password" id="repeatPASS" size="20" name="repeatPASS">
          </td>
        </tr>
        <tr>
          <td>Network SSID:</td>
        ...
        <tr>
          ...
          <td>
            <input type="text" id="outPASS" size="20" name="outPASS">
          </td>
        </tr>
        <tr>
          <td>IP Address:</td>
    ...
    <form method="POST" id="time" action="/time">
      <table align="center">
        ...
        <tr>
          <td>Date and time:</td>
          <td>
            <input type="datetime-local" id="datetime" name="datetime" min="2000-01-01T00:00">
          </td>
        </tr>
        <tr>
          <td>Timezone:</td>
          <td>
            <input type="text" id="timezone" size="20" name="timezone">
          </td>
        </tr>
        <tr>
          <td>Use NTP Server:</td>
          <td>
            <input type="checkbox" id="useNTP" value="1" name="useNTP">
          </td>
        </tr>
        <tr>
          <td>NTP Server:</td>
